...
public class AmoCallSenderBAK extends Thread {
//
//    private static Logger LOGGER = LoggerFactory.getLogger(AmoCallSenderBAK.class.getSimpleName());
