...
public class ScriptController {
    ...
    @RequestMapping(value = "/get/{sitename}", method = RequestMethod.POST, produces = {"application/json; charset=UTF-8"})
    @ResponseBody
    public String getScript(HttpServletRequest request, String sitename) {
...
//        String script = "<script src=\\\"http://localhost:8080/tracking/script/" + name + "\\\"></script>";
    ...
    @RequestMapping(value = "/{login}/{site}", method = RequestMethod.GET, produces = {"text/html; charset=UTF-8"})
    @ResponseBody
...
//                    "loadScript(\"https://code.jquery.com/jquery-1.12.4.min.js\",runMyCodeAfterJQueryLoaded);";
        ...
        script = script.replaceAll("SITENAME", siteObject.getLogin());
