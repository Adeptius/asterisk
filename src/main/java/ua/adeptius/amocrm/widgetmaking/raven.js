!function (a) {
    ...
    return function a(b, c, d) {
        ...
        1: [function (a, b, c) {
            ...
            var d = function (a, b, c) {
                ...
                if (b in a) {
                    ...
                    a[b] = function () {
                        var a = [].slice.call(arguments), b = "" + a.join(" "),
            ...
            (function (c) {
                ...
                var x = a(7), y = a(2), z = a(6), A = z.isError, B = z.isObject, C = a(1), D = a(3).wrapMethod,
                    ...
                    H = G.document, I = G.navigator;
                e.prototype = {
                    VERSION: "3.12.1", debug: !1, TraceKit: x, config: function (a, b) {
                        var c = this;
                        ...
                        if (!A(a)) return this.captureMessage(a, k({trimHeadFrames: 1, stacktrace: !0}, b));
                        this.d = a;
                        try {
                        ...
                        if (!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(a)) {
                            ...
                            if (this.k.stacktrace || b && b.stacktrace) {
                                ...
                                d.name = null, b = k({fingerprint: a, trimHeadFrames: (b.trimHeadFrames || 0) + 1}, b);
                        ...
                        var b = k({timestamp: d() / 1e3}, a);
                        if (g(this.k.breadcrumbCallback)) {
                            var c = this.k.breadcrumbCallback(b);
                            if (B(c) && !i(c)) b = c; else if (c === !1) return this
                        }
                        ...
                        var g;
                        if ((!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(b)) && (b += "", e && e.length ? (c = e[0].filename || c, e.reverse(), g = {frames: e}) : c && (g = {
                                frames: [{
                                    filename: c,
                                    lineno: d,
                                    in_app: !0
                            ...
                            var h = k({exception: {values: [{type: a, value: b, stacktrace: g}]}, culprit: c}, f);
                            this.P(h)
                        }
                    }, Z: function (a) {
                        ...
                        if (this.c || this.b) {
                            var a = {};
                            return this.c && I.userAgent && (a.headers = {"User-Agent": navigator.userAgent}), this.b && (H.location && H.location.href && (a.url = H.location.href), H.referrer && (a.headers || (a.headers = {}), a.headers.Referer = H.referrer)), a
                        }
                    }, x: function () {
                        ...
                        function b() {
                            if (200 === c.status) a.onSuccess && a.onSuccess(); else if (a.onError) {
                                var b = new Error("Sentry error code: " + c.status);
                                b.request = c, a.onError(b)
                            }
                        }

                        var c = new XMLHttpRequest, d = "withCredentials" in c || "undefined" != typeof XDomainRequest;
                        if (d) {
                            var e = a.url;
        ...
        }, {1: 1, 2: 2, 3: 3, 6: 6, 7: 7}], 5: [function (a, b, c) {
            (function (c) {
                "use strict";
                var d = a(4),
            ...
            (function (c) {
                ...
                var e = a(6), f = {collectWindowErrors: !0, debug: !1},
                    g = "undefined" != typeof window ? window : "undefined" != typeof c ? c : "undefined" != typeof self ? self : {},
                    h = [].slice, i = "?",
