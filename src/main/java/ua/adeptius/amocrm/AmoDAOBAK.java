...
public class AmoDAOBAK {

    private static Logger LOGGER = LoggerFactory.getLogger(AmoDAOBAK.class.getSimpleName());
...
//        Проверяем права на создание сделок
        ...
        try {
            AmoDAOBAK.removeDeal(domain, userLogin, userApiKey, dealId);
        } catch (Exception e) {
